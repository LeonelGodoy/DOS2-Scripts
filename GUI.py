...
load = Image.open("LEVELS_Icon.jpg")
render = ImageTk.PhotoImage(load.resize((500, 500)))
...
def on_click(event=None):
    ...
    webbrowser.open("https://steamcommunity.com/sharedfiles/filedetails/?id=1886059329&searchtext=")


# bind click event to image
img.bind('<Button-1>', on_click)

explanation = """This is a tool used to do massive edits \n for stats in The Divinity Engine 2. 
I worked on this while creating my 
standalone adventure, LEVELS, 
check it out by clicking on 
the image on the left!
 """
w = Label(root, text=explanation, justify=LEFT, anchor=N)
w.pack()
w.place(bordermode=OUTSIDE, height=400, width=200, x=501, y=95)

button_1.pack()
button_1.place(bordermode=OUTSIDE, height=30, width=200, x=500, y=5)
button_2.pack()
button_2.place(bordermode=OUTSIDE, height=30, width=200, x=500, y=35)
button_3.pack()
button_3.place(bordermode=OUTSIDE, height=30, width=200, x=500, y=65)
